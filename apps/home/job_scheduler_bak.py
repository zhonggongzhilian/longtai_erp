        ...
        for device in devices:
            ...
            for order_product in order_products:
                ...
                if device.raw == raw_code:
                    ...
                    if process:
                        ...
                        num_processes_needed = (product_num_todo + process_capacity - 1) // process_capacity  # 向上取整
                        for _ in range(num_processes_needed):
                            # 进行排产
                            ...
                            # order_product.product_num_todo -= process_capacity

                        print(f"{device.start_time}, {device.end_time}, {order_product.order.order_code}, "
                              f"{order_product.product_code}, {process['process_i']}, "
                              f"{process['process_name']}, {device.device_name}, {product_num}, {0}")
            ...
            for order_product in order_products:
                ...
                if process:
                    ...
                    print(f"{device.start_time}, {device.end_time}, {order_product.order.order_code}, "
                          f"{order_product.product_code}, {process['process_i']}, "
                          f"{process['process_name']}, {device.device_name}, {product_num}, {1}")
